package nl.techwolf12.comboboxseekbar;
...
public class ComboSeekBar extends SeekBar implements SeekBar.OnSeekBarChangeListener {
    ...
    public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
        ...
        if (mOnValueChangeListener != null && mValues.get(i) != null) {
            mOnValueChangeListener.onValueChanged(this, i, mValues.get(i), b);
        }
    }
    ...
    public interface OnValueChangeListener {
        void onValueChanged(SeekBar seekBar, int position, String value, boolean userInitiated);
    }
}
